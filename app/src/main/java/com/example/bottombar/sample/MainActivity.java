...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.small_badges).setOnClickListener(this);
        findViewById(R.id.center_in_parent).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.badges:
                ...
                break;
            case R.id.small_badges:
                clazz = SmallBadgeActivity.class;
                break;
            case R.id.center_in_parent:
                clazz = CenteredActivity.class;
        }
